...
# Add opt/go/bin to path if it exists
...
# Git tree
alias gitree="git log --color --graph --pretty=format:'%Cred%h%Creset -%C(yellow)%d%Creset %s %Cgreen(%cr)%C(bold blue) <%an> %Creset' --abbrev-commit"
...
# Set editor and alias code to that editor
export EDITOR=nvim
alias code='$EDITOR'
alias editzsh='$EDITOR /home/$USER/.zshrc'
